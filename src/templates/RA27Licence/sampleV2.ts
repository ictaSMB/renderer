...
import { RA27LicenceDocumentSchemaV2 } from "./types";

export const RA27LicenceSampleV2: RA27LicenceDocumentSchemaV2 = {
  $template: {
    type: v2.TemplateType.EmbeddedRenderer,
    name: "RA27Licence",
    url: "https://legendary-biscotti-3e1f03.netlify.app",
  },
  issuers: [
    {
      name: "ICT Authority",
