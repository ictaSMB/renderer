...
import { DealersLicenceDocument, DealersLicenceDocumentSchema } from "./types";
...
export const DealersLicenceTemplate: FunctionComponent<TemplateProps<DealersLicenceDocumentSchema>> = ({
  document,
}) => {
  const { licenceno, effectivedate, recipientname, recipientbrnorcoi, recipientaddress, links } = getDocumentData(
    document
  ) as DealersLicenceDocument;
  ...
  const isInArray = invaliddealers.includes(licenceno);
  ...
  function brn_or_company_no(recipientbrnorcoi: string): JSX.Element {
    if (recipientbrnorcoi.toString().length == 9) {
      return (
        <h4 style={{ textAlign: "center" }}>
          <strong>(Business Registration No. {recipientbrnorcoi})</strong>
        </h4>
      );
    } else {
      return (
        <h4 style={{ textAlign: "center" }}>
          <strong>(Registrar of Companies file no. {recipientbrnorcoi})</strong>
        </h4>
      );
    }
  }
      ...
      <Coverpage>
        <div className="" id="cover-page">
          ...
          >
            ...
            {brn_or_company_no(recipientbrnorcoi)}
            <p style={{ textAlign: "justify" }}>
              having its registered office at <b>{recipientaddress}</b>, to sell, expose or offer for sale or hire a
        ...
        <div className="" id="terms-and-conditions_page1">
          ...
          <div style={{ marginTop: "6%", marginLeft: "5%", marginRight: "8%", position: "relative", lineHeight: 1.5 }}>
            ...
            <p style={{ textAlign: "justify" }}>
              <ol>
                <li value="1">
                  The Licence is granted to <strong>&quot;{recipientname}&quot;</strong>, hereinafter referred to as
                  &quot;the Licensee&quot;.
                </li>
              </ol>
              <ol>
      ...
      <Termsandconditionspage4>
        <div className="" id="terms-and-conditions_page4">
          ...
          <div style={{ marginTop: "0%", marginLeft: "5%", marginRight: "8%", position: "relative", lineHeight: 1.6 }}>
            ...
            <p style={{ textAlign: "center", marginTop: "110%" }}>4</p>
          </div>
        </div>
      </Termsandconditionspage4>
    </>
